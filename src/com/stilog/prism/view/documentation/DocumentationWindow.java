package com.stilog.prism.view.documentation;
...
public class DocumentationWindow extends JFrame {
    ...
    private static final String BASE_RESOURCE_PATH = "/com/stilog/prism/view/documentation/web/";
    ...
    /**
     * Charge le contenu HTML depuis les ressources
     */
    ...
    private String loadCSSFromResources() throws IOException {
        ...
        InputStream is = getClass().getResourceAsStream(resourcePath);
        if (is == null) {
            throw new IOException("CSS introuvable : " + resourcePath);
        }
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(is, StandardCharsets.UTF_8))) {
            return reader.lines().collect(Collectors.joining("\n"));
        }
